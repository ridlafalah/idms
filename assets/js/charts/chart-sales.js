...
!function (NioApp, $) {
  ...
  var salesRevenue = {
    ...
    datasets: [{
      label: "Sales Revenue",
      color: [NioApp.hexRGB("#1ee0ac", .2), NioApp.hexRGB("#1ee0ac", .2), NioApp.hexRGB("#1ee0ac", .2), NioApp.hexRGB("#1ee0ac", .2), NioApp.hexRGB("#1ee0ac", .2), NioApp.hexRGB("#1ee0ac", .2), NioApp.hexRGB("#1ee0ac", .2), NioApp.hexRGB("#1ee0ac", .2), NioApp.hexRGB("#1ee0ac", .2), NioApp.hexRGB("#1ee0ac", .2), NioApp.hexRGB("#1ee0ac", .2), "#1ee0ac"],
  ...
  var activeSubscription = {
    ...
    datasets: [{
      label: "Active User",
      color: [NioApp.hexRGB("#1ee0ac", .2), NioApp.hexRGB("#1ee0ac", .2), NioApp.hexRGB("#1ee0ac", .2), NioApp.hexRGB("#1ee0ac", .2), NioApp.hexRGB("#1ee0ac", .2), "#1ee0ac"],
  ...
  var salesOverview = {
    ...
    datasets: [{
      ...
      color: "#1ee0ac",
      background: NioApp.hexRGB('#20c997', .3),
